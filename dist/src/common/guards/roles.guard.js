...
let RolesGuard = class RolesGuard {
    ...
    canActivate(context) {
        ...
        const maxUserLevel = Math.max(...userRoles.map((r) => role_enum_1.ROLE_HIERARCHY[r] || 0));
        const minRequiredLevel = Math.min(...requiredRoles.map((r) => role_enum_1.ROLE_HIERARCHY[r] || 0));
