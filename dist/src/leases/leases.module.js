...
exports.LeasesModule = LeasesModule = __decorate([
    (0, common_1.Module)({
        imports: [properties_module_1.PropertiesModule, tenants_module_1.TenantsModule],
        controllers: [leases_controller_1.LeasesController],
        providers: [leases_service_1.LeasesService, lifecycle_service_1.LifecycleService],
        exports: [leases_service_1.LeasesService, lifecycle_service_1.LifecycleService],
    })
], LeasesModule);
